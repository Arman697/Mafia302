...
\033[1;91m☞ Auther     : Arman BLACK MAFIA 302✅
\033[1;92m☞ WhatsApp   : 03169010850
\033[1;95m☞ YouTube    : https://www.youtube.com/channel/UCRw3YGZqDjWqqtZWX91YkPA
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/ARMAN BLACK MAFIA')
	    os.system('cd $HOME && git clone https://github.com/Arman697/BlackMafia/')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03169010850✓')
	    psb('WellCome To BlackMafia')
	    psb('Congratulations BLACK MAFIA 302 Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Arman✓')
	    psb('🔓Password ☆ Arman✓')
	    psb('Subscrib My Youtube Chenal BLACK MAFIA 302✓')
